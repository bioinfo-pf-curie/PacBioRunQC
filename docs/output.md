...
|  Description      |  plot  |
| ------ | ------ |
|<span style="color:blue; text-align:center; vertical-align: center">**Productivity graph** <span style="color:black; text-align:center; vertical-align: center"> compares 'typical' values for the different productivity levels. **P0:** &nbsp;  Empty ZMW; no signal detected. **P1:** &nbsp; ZMW with a high quality read detected. **P2:** &nbsp; Other, signal detected but no high quality read. <ul><li>item1</li><li>item2</li></ul>| [<img src="plots/productivity.png" width="500"/>](plots/productivity.png)|
