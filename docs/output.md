...
* P1: ZMW with a high quality read detected. *  P2: Other, signal detected but no high quality read. | [<img src="plots/productivity.png" width="500"/>](plots/productivity.png)|
